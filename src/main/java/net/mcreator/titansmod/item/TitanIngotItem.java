...
public class TitanIngotItem extends TitansModModElements.ModElement {
	@ObjectHolder("titans_mod:titan_ingot")
	public static final Item block = null;
	public TitanIngotItem(TitansModModElements instance) {
		super(instance, 1);
	}
