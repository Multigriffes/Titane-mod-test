...
public class TitanenrichiestickItem extends TitansModModElements.ModElement {
	@ObjectHolder("titans_mod:titanenrichiestick")
	public static final Item block = null;
	public TitanenrichiestickItem(TitansModModElements instance) {
		super(instance, 74);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("titanenrichiestick");
		}
