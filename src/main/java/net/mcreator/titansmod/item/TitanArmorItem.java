...
public class TitanArmorItem extends TitansModModElements.ModElement {
	@ObjectHolder("titans_mod:titan_armor_helmet")
	public static final Item helmet = null;
	@ObjectHolder("titans_mod:titan_armor_chestplate")
	public static final Item body = null;
	@ObjectHolder("titans_mod:titan_armor_leggings")
	public static final Item legs = null;
	@ObjectHolder("titans_mod:titan_armor_boots")
	public static final Item boots = null;
	public TitanArmorItem(TitansModModElements instance) {
		super(instance, 17);
	}
