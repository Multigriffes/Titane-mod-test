...
public class TitannuggetItem extends TitansModModElements.ModElement {
	@ObjectHolder("titans_mod:titannugget")
	public static final Item block = null;
	public TitannuggetItem(TitansModModElements instance) {
		super(instance, 50);
	}
