...
public class TitanStickItem extends TitansModModElements.ModElement {
	@ObjectHolder("titans_mod:titan_stick")
	public static final Item block = null;
	public TitanStickItem(TitansModModElements instance) {
		super(instance, 42);
	}
