...
public class AssemblerguiGuiWindow extends ContainerScreen<AssemblerguiGui.GuiContainerMod> {
	...
	private static final ResourceLocation texture = new ResourceLocation("titans_mod:textures/assemblergui.png");
	@Override
	...
	protected void drawGuiContainerForegroundLayer(MatrixStack ms, int mouseX, int mouseY) {
		this.font.drawString(ms, "Assembler", 60, 7, -12829636);
	}
